...
class Match(db.Model):
    ...
    player1_utr = db.Column(db.Integer, nullable=True)
    player1_wtn = db.Column(db.Integer, nullable=True)
    player1_usta = db.Column(db.Integer, nullable=True)
    player1_seed = db.Column(db.Integer, nullable=True)
    player2_utr = db.Column(db.Integer, nullable=True)
    player2_wtn = db.Column(db.Integer, nullable=True)
    player2_usta = db.Column(db.Integer, nullable=True)
    player2_seed = db.Column(db.Integer, nullable=True)
    player3_utr = db.Column(db.Integer, nullable=True)
    player3_wtn = db.Column(db.Integer, nullable=True)
    player3_usta = db.Column(db.Integer, nullable=True)
    player3_seed = db.Column(db.Integer, nullable=True)
    player4_utr = db.Column(db.Integer, nullable=True)
    player4_wtn = db.Column(db.Integer, nullable=True)
    player4_usta = db.Column(db.Integer, nullable=True)
    player4_seed = db.Column(db.Integer, nullable=True)
